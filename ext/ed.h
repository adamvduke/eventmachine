...
class EventableDescriptor: public Bindable_t
{
	public:
		...
		virtual void SetTlsParms (const char *privkey_filename, const char *certchain_filename, bool verify_peer, const char *privatekey_string, const char *certchain_string) {}
