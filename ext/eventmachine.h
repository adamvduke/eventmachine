...
extern "C" {
	...
	void evma_set_tls_parms (const unsigned long binding, const char *privatekey_filename, const char *certchain_filenane, int verify_peer, const char *privatekey_string, const char *certchain_string);
